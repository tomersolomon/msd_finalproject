...
# load files
read.delim("../data/wikispeedia_paths-and-graph/paths_unfinished.tsv", skip = 16, header = F) -> paths_unfin
head(paths_unfin)

read.delim("../data/wikispeedia_paths-and-graph/paths_finished.tsv", skip = 15, header = F) -> paths_fin
head(paths_fin)
...
# load file
read.delim("../data/wikispeedia_paths-and-graph/categories.tsv", skip = 12, header = FALSE) -> categories_map
head(categories_map)
